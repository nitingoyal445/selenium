...
public class StepDefHJotel {
	...
	public void user_is_on_hotel_booking_page() throws Throwable {
		...
		driver.get("file:///C:\\Users\\NITIGOYA\\Downloads\\BDD-master\\BDD-master\\hotelbooking.html");
	...
	public void user_enters_all_valid_data() throws Throwable {
		...
		hotelobj.setPfcardholder("komal agrawal");
		Thread.sleep(1000);
	...
	public void navigate_to_welcome_page() throws Throwable {
		driver.navigate().to("file:///C:\\Users\\NITIGOYA\\Downloads\\BDD-master\\BDD-master\\success.html");
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		driver.close();
	}
